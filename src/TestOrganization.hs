...
main = do
  ...
  quickCheck (prop_reflective_json_instance :: Organization -> Bool)
...
prop_merging_like_orgs :: (ContactInfo, [ContactInfo], [ContactInfo]) -> Bool
...
prop_merging_unlike_orgs
  :: (ContactInfo, ContactInfo, [ContactInfo], [ContactInfo]) -> Property
...
prop_orgs_merged_with_self :: [Organization] -> Bool
...
prop_org_merged_with_orgs :: [Organization] -> Bool
...
prop_reflective_csv_conversion :: Organization -> Bool
